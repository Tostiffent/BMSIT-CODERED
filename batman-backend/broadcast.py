...
class Broadcast:
    ...
    def __init__(self, port = 1200, broadcastAddress = '<broadcast>'):
    ...
    def txBroadcast(self, data: str):
        """Handles transmitting broadcasts."""
        self.tx_sock.sendto(bytes(data, "utf-8"), (self.broadcastAddress, self.port))
